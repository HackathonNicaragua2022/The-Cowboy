...
class DatosDocenteWidget extends StatefulWidget {
  const DatosDocenteWidget({Key? key}) : super(key: key);

  @override
  _DatosDocenteWidgetState createState() => _DatosDocenteWidgetState();
}

class _DatosDocenteWidgetState extends State<DatosDocenteWidget> {
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        setState(() =>
                            FFAppState().mifototemporal = uploadedFileUrl);
                      },
                      child: Image.network(
                        valueOrDefault<String>(
                          FFAppState().mifototemporal,
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          InkWell(
                            onTap: () async {
                              final datePersonaldocCreateData =
                                  createDatePersonaldocRecordData(
                              ...
                              await DatePersonaldocRecord.collection
                                  .doc()
                                  .set(datePersonaldocCreateData);
                              await showDialog(
                                context: context,
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Correcto'),
                                    content: Text('Has Agregado un Docente'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
                              ...
                              setState(() => FFAppState().mifototemporal =
                                  'https://png.pngtree.com/png-vector/20210604/ourlarge/pngtree-gray-avatar-placeholder-png-image_3416697.jpg');
                            },
                            child: Image.asset(
