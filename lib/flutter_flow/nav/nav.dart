...
class AppStateNotifier extends ChangeNotifier {
  ToolsSchoolFirebaseUser? initialUser;
  ToolsSchoolFirebaseUser? user;
  ...
  void update(ToolsSchoolFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'botonedocentes',
              path: 'botonedocentes',
              builder: (context, params) => BotonedocentesWidget(),
            ),
            FFRoute(
              name: 'botoneestudiante',
              path: 'botoneestudiante',
              builder: (context, params) => BotoneestudianteWidget(),
            ),
            FFRoute(
              name: 'MenuAdmin',
              path: 'menuAdmin',
            ...
            FFRoute(
              ...
              builder: (context, params) => BuscarEstudianteWidget(),
            ),
            FFRoute(
              name: 'Datos_Docente',
              path: 'datosDocente',
